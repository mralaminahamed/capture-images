...
webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].runtime.onInstalled.addListener(function () {
...
webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].contextMenus.onClicked.addListener(sendCaptureImagesRequest);
//capture event on click action button
webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].browserAction.onClicked.addListener(sendCaptureImagesRequest);
function sendCaptureImagesRequest() {
    webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].tabs.query({ active: true, currentWindow: true }).then(function (tabs) {
        console.log(tabs);
        webextension_polyfill_ts__WEBPACK_IMPORTED_MODULE_0__["browser"].tabs.sendMessage(tabs[0].id, { session: 'makePopUp' }).then(r => console.log(r));
    });
}
